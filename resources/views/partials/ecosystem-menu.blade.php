...
<div class="hidden xl:flex bg-charcoal items-center justify-center px-4 sm:px-8 md:px-16 lg:px-32 py-0 h-10 w-full">
    ...
    <div class="flex gap-2.5 items-center justify-center self-stretch shrink-0">
        <div class="font-inter-tight text-sm leading-[1.42] text-mine-shaft-50 font-bold">
    ...
    <div class="flex gap-px items-center justify-start shrink-0">
        ...
        <div class="bg-charcoal flex gap-2.5 items-center justify-start px-5 py-2.5 text-sm leading-[1.42]">
            <a href="https://github.com/magento/magento2" target="_blank" class="font-inter-tight text-mine-shaft-50 font-bold no-underline hover:text-orange transition-colors duration-200">Magento Open Source</a>
        ...
        {{-- Separator line --}}
        <div class="h-10 w-px bg-mine-shaft-400"></div>

        {{-- Magento Association --}}
        <div class="bg-charcoal flex gap-2.5 items-center justify-start px-5 py-2.5 text-sm leading-[1.42]">
            <a href="https://www.magentoassociation.org/home" target="_blank" class="font-inter-tight text-mine-shaft-50 font-bold no-underline hover:text-orange transition-colors duration-200">Magento Association</a>
            <svg width="8" height="11" viewBox="0 0 8 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.75 11C1.50391 11 1.28516 10.918 1.12109 10.7539C0.765625 10.4258 0.765625 9.85156 1.12109 9.52344L4.86719 5.75L1.12109 2.00391C0.765625 1.67578 0.765625 1.10156 1.12109 0.773438C1.44922 0.417969 2.02344 0.417969 2.35156 0.773438L6.72656 5.14844C7.08203 5.47656 7.08203 6.05078 6.72656 6.37891L2.35156 10.7539C2.1875 10.918 1.96875 11 1.75 11Z" fill="#F26423"/>
            </svg>
        ...
        {{-- Meet Magento --}}
        <div class="bg-charcoal flex gap-2.5 items-center justify-start px-5 py-2.5 text-sm leading-[1.42]">
            <a href="https://www.meet-magento.com/" target="_blank" class="font-inter-tight text-mine-shaft-50 font-bold no-underline hover:text-orange transition-colors duration-200">Meet Magento</a>
            <svg width="8" height="11" viewBox="0 0 8 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.75 11C1.50391 11 1.28516 10.918 1.12109 10.7539C0.765625 10.4258 0.765625 9.85156 1.12109 9.52344L4.86719 5.75L1.12109 2.00391C0.765625 1.67578 0.765625 1.10156 1.12109 0.773438C1.44922 0.417969 2.02344 0.417969 2.35156 0.773438L6.72656 5.14844C7.08203 5.47656 7.08203 6.05078 6.72656 6.37891L2.35156 10.7539C2.1875 10.918 1.96875 11 1.75 11Z" fill="#F26423"/>
            </svg>
        </div>
        ...
        <div class="bg-charcoal flex gap-2.5 items-center justify-start px-5 py-2.5 text-sm leading-[1.42]">
            <a href="https://devdocs.mage-os.org/" target="_blank" class="font-inter-tight text-mine-shaft-50 font-bold no-underline hover:text-orange transition-colors duration-200">Development Resources</a>
